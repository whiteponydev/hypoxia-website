...
function init() {
  ...
  scene.fog = new THREE.Fog( 0xff4d4d, 2, 20 );
  ...
  const mesh = new THREE.Mesh( new THREE.PlaneGeometry( 50, 50 ), new THREE.MeshPhongMaterial( { color: 0xb30000, depthWrite: false } ) );
  mesh.rotation.x = - Math.PI / 2;
  mesh.receiveShadow = true;
  scene.add( mesh );

  const grid = new THREE.GridHelper( 50, 50, 0xff0000, 0xff0000 );
  scene.add( grid );
